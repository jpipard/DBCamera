...
- (id) initWithImage:(UIImage *)image thumb:(UIImage *)thumb
{
    ...
    if (self) {
        ...
        _filtersList = @[ @"normal", @"cook", @"vasco", @"grey", @"armstrong", @"cartier", @"magellan", @"colombus", @"contrastgrey", @"vignette" ];
        
        NSBundle *bundle = [NSBundle bundleForClass:self.class];
        NSURL *filter1977      = [NSURL fileURLWithPath:[bundle pathForResource:@"cook"      ofType:@"acv"]];
        NSURL *filterAmaro     = [NSURL fileURLWithPath:[bundle pathForResource:@"vasco"     ofType:@"acv"]];
        NSURL *filterHudson    = [NSURL fileURLWithPath:[bundle pathForResource:@"armstrong" ofType:@"acv"]];
        NSURL *filterMayfair   = [NSURL fileURLWithPath:[bundle pathForResource:@"cartier"   ofType:@"acv"]];
        NSURL *filterNashville = [NSURL fileURLWithPath:[bundle pathForResource:@"magellan"  ofType:@"acv"]];
        NSURL *filterValencia  = [NSURL fileURLWithPath:[bundle pathForResource:@"colombus"  ofType:@"acv"]];
